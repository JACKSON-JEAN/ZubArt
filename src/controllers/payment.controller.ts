...
export class PaymentController {
  ...
  /**
   * Browser callback after user pays (Pesapal redirects here)
   */
  // @Get('callback')
  // async handleCallback(@Query('OrderTrackingId') orderTrackingId: string, @Res() res: Response) {
  ...
  //     return { status: 'failed', message: error.message || 'Verification failed' };
  //   }
  // }
